...
**Live page:** https://necmettintamgueney.github.io/variants-dashboard/variant_grouping_model_analysis.html

**Repo:** https://github.com/necmettintamgueney/variants-dashboard

The file to review and edit is `variant_grouping_model_analysis.html` at the repo root. It is the single source of truth that deploys to the live page.
...
- The page also has a build pipeline (`build_report.py`) that is not used for deploys. **Edit the HTML file directly.** Do not regenerate from the build script.
...
- Changes committed and the live page reflects them.
